...
function drawFinish() {
	...
	canvas.textAlign = "center";
	canvas.fillText("现在请闭上眼睛试试", cwh(CANVAS_WIDTH / 2) + os.x, cwh(280) + os.y);
	
	// data
	canvas.fillStyle = "#555";
	canvas.font = cwh(24) + "px Arial";
	canvas.textAlign = "left";
	canvas.fillText("失败:", cwh(finish_data_left) + os.x, cwh(370) + os.y);
	
	canvas.fillStyle = "#555";
	canvas.font = cwh(24) + "px Arial";
	canvas.textAlign = "left";
	canvas.fillText("时间:", cwh(finish_data_left) + os.x, cwh(400) + os.y);
	...
	canvas.textAlign = "center";
	canvas.fillText("返回菜单 ", cwh(CANVAS_WIDTH / 2) + os.x, cwh(535) + os.y);
