...
function LS_draw_nav() {
	...
	canvas.fillText("<< 上一页", cwh(15) + os.x, cwh(535) + os.y);
	...
	canvas.font = cwh(25) + "px Arial Black";
	canvas.textAlign = "center";
	canvas.fillText("返回主菜单 ", cwh(CANVAS_WIDTH / 2) + os.x, cwh(535) + os.y);
	...
	canvas.fillText("下一页 >>", cwh(CANVAS_WIDTH - 15) + os.x, cwh(535) + os.y);
}